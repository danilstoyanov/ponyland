...
export default class StickerTabBase<Category extends StickersTabCategory<any, any>, T = any> implements EmoticonsTab {
  ...
  constructor(options: {
    ...
    noMenu?: boolean,
    searchFetcher?: StickerTabBase<Category, T>['searchFetcher'],
    groupFetcher?: StickerTabBase<Category, T>['groupFetcher'],
    processSearchResult?: StickerTabBase<Category, T>['processSearchResult'],
