const lang = {
  ...
  'LiveStream.Bar.Title': 'Live Stream',
  'LiveStream.Bar.Watching': '%d watching',
  'LiveStream.Bar.Join': 'JOIN',
  'LiveStream.PopUp.Stream.EndStream.Title': 'End Livestream',
  'LiveStream.PopUp.Stream.EndStream.Description': 'Are you sure you want to end this livestream?',
  'LiveStream.PopUp.Stream.EndStream.End': 'End',
  'LiveStream.PopUp.Stream.EndStream.Cancel': 'Cancel',
  'LiveStream.PopUp.Stream.TitleSettings': 'Stream Settings',
  'LiveStream.PopUp.Stream.RevokeStreamKey': 'Revoke Stream Key',
  'LiveStream.PopUp.Stream.RevokeStreamKeyConfirm': 'Are you sure you want to revoke your Stream Key?',
  'LiveStream.PopUp.Stream.Revoke': 'Revoke',
  'LiveStream.PopUp.Stream.RevokeCancel': 'No',
  'LiveStream.PopUp.Stream.EndLiveStream': 'END LIVE STREAM',
  'LiveStream.PopUp.Stream.Title': 'Stream With...',
  'LiveStream.PopUp.Stream.Description': 'To stream video with another app, enter these Server URL and Stream Key in your streaming app. Software encoding recommended (x264 in OBS).',
  'LiveStream.PopUp.Stream.ServerURL': 'Server URL',
  'LiveStream.PopUp.Stream.StreamKey': 'Stream Key',
  'LiveStream.PopUp.Stream.Hint': 'Once you start broadcasting in your streaming app, click Start Streaming below.',
  'LiveStream.PopUp.Stream.StartStreaming': 'START STREAMING',
  'LiveStream.PopUp.Recording.Title': 'Start Recording',
  'LiveStream.PopUp.Recording.RecordingTitle': 'Recording Title',
  'LiveStream.PopUp.Recording.RecordingQuestion': 'Record this stream and save the result into a file?',
  'LiveStream.PopUp.Recording.RecordingHint': 'Participants will see that the chat is being recorded.',
  'LiveStream.PopUp.Recording.AlsoRecordVideo': 'Also Record Video',
  'LiveStream.PopUp.Recording.RecordAudioHint': 'This chat will be recorded into an audio file',
  'LiveStream.PopUp.Recording.RecordVideoHint': 'Choose video orientation',
  'LiveStream.PopUp.Recording.ButtonRecord': 'START RECORDING',
  'LiveStream.PopUp.OutputDevice.Title': 'Output Device',
  'LiveStream.PopUp.OutputDevice.Default': 'Default',
  'LiveStream.MediaViewer.Menu.Option.OutputDevice': 'Output Device',
  'LiveStream.MediaViewer.Menu.Option.StartRecording': 'Start Recording',
  'LiveStream.MediaViewer.Menu.Option.StreamSettings': 'Stream Settings',
  'LiveStream.MediaViewer.Menu.Option.EndLiveStream': 'End Live Stream',
  'LiveStream.MediaViewer.Streaming': 'streaming',
  'LiveStream.RtmpUrl.Copied': 'Stream server URL is copied',
  'LiveStream.Key.Copied': 'Stream key is copied',
  'LiveStream.Key.Revoked': 'Stream key is revoked',
  'LiveStream.MediaViewer.Live': 'LIVE',
  'LiveStream.MediaViewer.Failed.Title': 'Oops!',
  'LiveStream.MediaViewer.Failed.Description': 'Telegram doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'PeerInfo.Action.VideoStream': 'Video Stream Contest Stream Info Popup',
  'PeerInfo.Action.VideoStreamBrowse': 'Video Stream Browse',
